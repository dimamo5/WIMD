<template>
        <div class="panel panel-red">
          <div class="panel-heading dark-overlay">Conditions <i class="pull-right fa fa-plus options-header clicable" aria-hidden="true" data-toggle="modal" data-target="#create-condition"></i></div>
          <div class="panel-body">
            <ul class="todo-list">
              <li class="todo-list-item" v-for="labTest in labTests">
