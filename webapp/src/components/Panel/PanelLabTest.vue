<template>
        <div class="panel panel-red">
          <div class="panel-heading dark-overlay">Lab Tests <i class="pull-right fa fa-plus options-header clicable" aria-hidden="true" data-toggle="modal" data-target="#create-lab-test"></i></div>
